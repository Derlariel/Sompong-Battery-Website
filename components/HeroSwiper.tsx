  ...
  return (
    ...
    >
      <Swiper
        ...
        autoplay={hasMultipleSlides ? { delay: 4800, disableOnInteraction: false } : false}
      ...
      <div className="absolute inset-0 z-20 flex h-full max-w-[640px] flex-col justify-center px-[6%] pb-[7%] pt-[6.5%] max-[720px]:max-w-none max-[720px]:px-[7%] max-[720px]:pb-[14%] max-[720px]:pt-[9%]">
        <div
          ...
          style={{ fontFamily: "Kanit, Tahoma, sans-serif", fontSize: "clamp(13px, 1.6vw, 15px)" }}
        >
        ...
        <div className="my-[1.2em] flex items-center gap-[.6rem]">
          ...
          <p className="m-0 text-[#9FB0C4]" style={{ fontSize: "clamp(14px, 1.7vw, 16.5px)", lineHeight: 1.55 }}>
            เช็คระบบไฟ ตรวจไดร์ชาร์จ-ไดร์สตาร์ท และเปลี่ยนแบตเตอรี่นอกสถานที่ ทั่วกรุงเทพฯ ภายใน 30 นาที
            โดยช่างผู้เชี่ยวชาญรถยนต์โดยเฉพาะ
          </p>
        </div>
        ...
        <div className="flex flex-wrap gap-[.85rem]">
          <a
            ...
            style={{ fontFamily: "Kanit, Tahoma, sans-serif", fontSize: "clamp(14px, 1.8vw, 16.5px)", lineHeight: 1.5 }}
      ...
      <div
        ...
        style={{ fontFamily: "Kanit, Tahoma, sans-serif", fontSize: "clamp(11px, 1.3vw, 13px)" }}
      >
        Sompong Battery <b className="font-semibold tracking-[.02em] text-[#F4F6F9]">·</b> บริการทุกเขตในกรุงเทพฯ
      </div>

      {hasMultipleSlides && (
        <div className="absolute bottom-[6%] right-[5%] z-30 flex gap-2" role="group" aria-label="เลือกภาพบริการ">
          {slides.map((slide, index) => (
            <button
              ...
              className="h-1 w-[26px] rounded-sm border-0 p-0 transition-colors duration-200"
              style={{ background: active === index ? "#FFC53D" : "rgba(255,255,255,.32)" }}
            />
          ))}
        </div>
      )}
